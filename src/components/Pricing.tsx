  ...
  return (
    <Container className="px-4 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-3 xl:grid-cols-3">
        {/* Free Plan */}
        <div className="flex flex-col justify-between w-full h-full bg-white px-8 rounded-2xl py-10 shadow-lg">
          <div>
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9" style={{color: "#f4a300"}}>
        ...
        {/* Pay-as-You-Go Plan */}
        <div className="flex flex-col justify-between w-full h-full bg-white px-8 rounded-2xl py-10 shadow-lg relative">
        ...
        <div className="flex flex-col justify-between w-full h-full bg-white px-8 rounded-2xl py-10 shadow-lg">
          <div>
            ...
            <div className="text-center mb-8">
              <span className="text-4xl font-bold text-gray-800 dark:text-white">Contact Us</span>
              <div className="flex justify-center mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9" style={{color: "#f4a300"}}>
